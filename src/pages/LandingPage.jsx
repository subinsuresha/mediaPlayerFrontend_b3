  ...
  return (
    ...
    <Row className='d-flex justify-content-center align-items-center'>
      ...
      <Col lg={5}>
        ...
        <p style={{textAlign:'justify'}} className='mt-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci maxime voluptates eaque vitae eius cum perspiciatis doloribus ratione facilis? Veritatis ipsa explicabo hic dicta! Quaerat voluptatem expedita deserunt dignissimos atque.lorem.
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci maxime voluptates eaque vitae eius cum perspiciatis doloribus ratione facilis? Veritatis ipsa explicabo hic dicta! Quaerat voluptatem expedita deserunt dignissimos atque.lorem</p>
    ...
    <div className="container border border-2 rounded border-secondary p-5 mt-5 mb-5">
     <Row>
      ...
      <Col lg={5}>
        ...
        <p> <span className='fs-5 fw-bolder'>Play Everything</span> : Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium animi, neque tenetur consequatur placeat numquam quam labore, quia fuga deleniti incidunt doloribus quibusdam et nemo maxime? Quibusdam repellat accusamus iste.</p>
        <p> <span className='fs-5 fw-bolder'>Play Everything</span> : Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium animi, neque tenetur consequatur placeat numquam quam labore, quia fuga deleniti incidunt doloribus quibusdam et nemo maxime? Quibusdam repellat accusamus iste.</p>
        <p> <span className='fs-5 fw-bolder'>Play Everything</span> : Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium animi, neque tenetur consequatur placeat numquam quam labore, quia fuga deleniti incidunt doloribus quibusdam et nemo maxime? Quibusdam repellat accusamus iste.</p>
      </Col>
      <Col></Col>
